...
CREATE TABLE IF NOT EXISTS `users`(`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(50) NOT NULL,`mail` VARCHAR(100) NOT NULL,`warframePseudo` VARCHAR(50) NOT NULL,`password` VARCHAR(20) NOT NULL,`tagDiscord` VARCHAR(15), PRIMARY KEY(`id`)) ENGINE=INNODB;
CREATE TABLE IF NOT EXISTS `factions`(`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(30) NOT NULL,PRIMARY KEY(`id`)) ENGINE=INNODB;
CREATE TABLE IF NOT EXISTS `Armors`(`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(30) NOT NULL, `url` VARCHAR(150) NOT NULL, PRIMARY KEY(`id`)) ENGINE=INNODB;
CREATE TABLE IF NOT EXISTS `players`(`id` INT NOT NULL AUTO_INCREMENT, `name` INT NOT NULL, `faction` INT NOT NULL, `rank` TINYINT(1) NOT NULL, `standing` INT, `url` INT NOT NULL, PRIMARY KEY (`id`)) ENGINE=INNODB;
...
# insertion d'info dans la table factionRank
